...
public static class ReflectionExtensions
{
    ...
    /// <summary>
    /// Get value of the private static field from specific object.
    /// </summary>
    /// <param name="source">Object to get field value</param>
    /// <param name="fieldName">Name of field.</param>
    /// <typeparam name="T">Type of field value.</typeparam>
    /// <returns>Value of the property.</returns>
    /// <exception cref="ArgumentNullException"><param name="source" /> or <param name="fieldName" /> is null.</exception>
    public static T? GetPrivateStaticField<T>(this object source, string fieldName)
    {
        if (source == null)
        {
            throw new ArgumentNullException(nameof(source));
        ...
        Type t = source.GetType();
        FieldInfo? field = t.GetField(fieldName, BindingFlags.Static | BindingFlags.NonPublic);
